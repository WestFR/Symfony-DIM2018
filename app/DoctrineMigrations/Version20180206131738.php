 ...
 */
class Version20180206131738 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE s_shows (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abstract LONGTEXT NOT NULL, country VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, release_date DATE NOT NULL, main_picture VARCHAR(255) NOT NULL, INDEX IDX_172DA9B312469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE s_shows ADD CONSTRAINT FK_172DA9B312469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE s_shows');
    }
}

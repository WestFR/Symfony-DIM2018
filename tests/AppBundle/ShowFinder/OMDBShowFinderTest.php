...
class OMDBShowFinderTest extends TestCase
{
	...
	{
		$OMDBJson = '{"Title": "Johnny Test","Plot": "Description",Released": "01 Jan 2005","Writer": "Realisator",Genre": "Adventure","Country": "USA, Canada","Poster": "https:\/\/ia.media-imdb.com\/images\/M\/MV5BYzc3OGZjYWQtZGFkMy00YTNlLWE5NDYtMTRkNTNjODc2MjllXkEyXkFqcGdeQXVyNjExODE1MDc@._V1_SX300.jpg", "Response":"true"}';
		...
		$expectedShow->setAbstract('Not provided.');
		$expectedShow->setDataSource('OMDB_API');
		$expectedShow->setCountry('USA, Canada');
